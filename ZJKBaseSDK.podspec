...
Pod::Spec.new do |s|
  s.name             = 'ZJKBaseSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZJKBaseSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/k721684713@163.com/ZJKBaseSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'k721684713@163.com' => '“zhangjikuan@winchannel.net”' }
  s.source           = { :git => 'https://github.com/k721684713@163.com/ZJKBaseSDK.git', :tag => s.version.to_s }
